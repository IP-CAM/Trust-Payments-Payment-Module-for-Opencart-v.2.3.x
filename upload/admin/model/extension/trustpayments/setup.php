...
class ModelExtensionTrustPaymentsSetup extends AbstractModel {
	...
	private function addEvents(){
		$this->getEventModel()->addEvent('trustpayments_create_dynamic_files', 'admin/controller/extension/modification/refresh/after',
	...
	private function removeEvents(){
		...
		$this->getEventModel()->deleteEvent('trustpayments_include_scripts');
	}
