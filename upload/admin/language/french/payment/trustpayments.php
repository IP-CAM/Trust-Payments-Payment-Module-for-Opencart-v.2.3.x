 ...
 */
// @formatter:off
$_['heading_title']									= "Trust Payments";
$_['heading_trustpayments']					= "Trust Payments";
$_['text_trustpayments']					= '<a target="_BLANK" href="https://www.trustpayments.com/"><img src="view/image/extension/payment/trustpayments.png" alt="Trust Payments Webseite" title="Trust Payments Webseite" style="border: 1px solid #EEEEEE;" /></a>';
// TrustPayments Configurations (user id, application key, spaces)
$_['title_global_settings']							= "Références globales";
$_['title_store_settings']							= "Paramètres du magasin";
$_['entry_user_id']									= "Id utilisateur";
$_['help_user_id']									= "Vous pouvez trouver votre ID utilisateur dans votre compte Trust Payments. Ce paramètre est partagé par tous les magasins";
$_['entry_application_key']							= "Clé d'application";
$_['help_application_key']							= "Votre clé d'application est affichée une fois lors de la configuration du Trust Payments. Ce paramètre est partagé par tous les magasins.";
$_['entry_space_id']								= "ID de l'espace";
$_['help_space_id']									= "Vous pouvez trouver votre Identifiant d'espace dans votre compte Trust Payments.";
...
$_['description_rounding_adjustment']				= "Si nous ne pouvons pas faire correspondre exactement les totaux d'Opencart aux postes de la Trust Payments, au lieu de désactiver les méthodes de paiement, vous pouvez choisir d'envoyer un élément d'ajustement qui contient la différence. Dans ce cas, il se peut que les montants des taxes ne soient plus exacts et que des fonctions telles que la réconciliation dans Trust Payments et les remboursements à partir du backend Opencart ne fonctionnent pas complètement.";

// Status
$_['title_payment_status']							= "Cartographie de l'état ";
$_['entry_processing_status'] 						= "Statut de traitement";
$_['description_processing_status'] 				= "Statut dans lequel la commande entre lorsque la transaction est dans le statut Trust Payments de traitement ou de confirmation. Ici, l'utilisateur est en train de saisir les détails de son paiement, ou les détails sont en cours de traitement.";
$_['entry_failed_status']    						= "Statut d'échec";
$_['description_failed_status']    					= "Statut dans lequel l'ordre entre lorsque la transaction est dans le statut Trust Payments failed.";
$_['entry_authorized_status'] 						= "Statut autorisé";
$_['description_authorized_status'] 				= "Statut dans lequel la commande entre lorsque la transaction est dans le statut autorisé Trust Payments. Ici, le montant a été réservé à partir du compte du client, et doit être complété manuellement.";
$_['entry_voided_status'] 							= "Statut annulé";
$_['description_voided_status'] 					= "Statut dans lequel l'ordre entre lorsque la transaction est dans le statut Trust Payments annulé.";
$_['entry_completed_status'] 						= "État d'achèvement";
$_['description_completed_status'] 					= "Statut dans lequel l'ordre entre lorsque la transaction est dans le statut Trust Payments completed. Ce statut n'est activé que si une décision manuelle pour l'accomplissement est requise.";
$_['entry_fulfill_status'] 							= "Remplir le statut";
$_['description_fulfill_status'] 					= "Statut dans lequel l'ordre entre lorsque la transaction est dans le statut de réalisation Trust Payments.";
$_['entry_decline_status'] 							= "Statut de déclin";
$_['description_decline_status'] 					= "État dans lequel l'ordre entre lorsque la transaction est dans l'état refusé Trust Payments.";
...
$_['description_administration']					= "Cette modification ajoute des informations sur le Trust Payments à la vue de la commande dans la zone d'administration, et permet d'initier des complétions, des remboursements et des annulations via Opencart.";
$_['entry_email']									= "Confirmation par courriel";
$_['description_email']								= "Vous pouvez désactiver ou activer les e-mails de confirmation de commande en utilisant notre modification, 'Prevent confirmation email'. Cette modification ne concerne que les commandes créées à l'aide du plugin de paiement Trust Payments.";
...
$_['description_events']							= "Cette modification simule des événements qui existent dans les versions ultérieures d'Opencart, mais qui ne sont pas présents dans 2.3.x. En raison de la nature de cette modification, toutes les modifications doivent être rafraîchies deux fois.";
 ...
 * ===========================================================================================
 */
$_['heading_transaction_list']				        = "TrustPayments Transactions";
 ...
 * ===========================================================================================
 */
$_['title_notifications']							= "Notifications Trust Payments";
...
$_['label_trustpayments_id']				= "Trust Payments ID";
$_['description_trustpayments_id']			= "ID interne utilisé par Trust Payments pour identifier la ressource";
$_['label_trustpayments_link']				= "Lien Trust Payments";
$_['description_trustpayments_link']		= "Ouvrir la ressource dans l'application Trust Payments";
...
// downloads
$_['description_downloads']							= "Téléchargez les documents générés par Trust Payments directement dans le backend de la boutique. Ces documents disponibles dépendent des paramètres du plugin, ainsi que de l'état de la transaction.";
$_['link_download']									= "Télécharger";
$_['label_invoice']									= "Facture";
$_['description_invoice']							= "Vous pouvez télécharger ici la facture créée par Trust Payments pour cette transaction.";
$_['label_packing']									= "Fiche d'emballage";
$_['description_packing']							= "Vous pouvez télécharger ici le bordereau d'expédition créé par Trust Payments pour cette transaction.";
...
$_['description_external']							= "ID externe transmis au Trust Payments. Sera généralement r-{order id}-{refund number}";
 ...
 * ===========================================================================================
 */
$_['heading_refund']								= "Trust Payments Remboursement";
...
$_['error_not_trustpayments']				= "L'identifiant de commande n'a pas pu être associé à une transaction Trust Payments";
