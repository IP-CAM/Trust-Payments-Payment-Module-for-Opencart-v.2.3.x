...
$_['help_user_id']									= "Sie finden Ihre Benutzer-ID in Ihrem Trust Payments-Konto. Diese Einstellung wird von allen Shops gemeinsam genutzt.";
$_['entry_application_key']							= "Application Key";
$_['help_application_key']							= "Ihr 'Application Key' wird einmalig beim Einrichten von Trust Payments angezeigt. Diese Einstellung wird von allen Shops gemeinsam genutzt.";
$_['entry_space_id']								= "Space ID";
$_['help_space_id']									= "Sie finden Ihre Space-ID in Ihrem Trust Payments-Konto.";
...
$_['description_rounding_adjustment']				= 'Wenn wir die Opencart-Gesamtsummen nicht genau den Trust Payments-Werbebuchungen zuordnen können, können Sie statt der Deaktivierung der Zahlungsmethoden stattdessen einen Anpassungsposten senden, der die Differenz enthält. In diesem Fall sind die Steuerbeträge möglicherweise nicht mehr genau und Funktionen wie der Abgleich in Trust Payments und Rückerstattungen aus dem Opencart-Backend funktionieren möglicherweise nicht vollständig.';

// Status
$_['title_payment_status']							= "Statuszuordnung";
$_['entry_processing_status'] 						= "Bearbeitungsstatus";
$_['description_processing_status'] 				= "Status, den die Bestellung einnimmt, wenn sich die Transaktion im Bearbeitungs- oder Bestätigungsstatus von Trust Payments befindet. Hier gibt der Benutzer seine Zahlungsdaten ein oder die Daten werden verarbeitet.";
$_['entry_failed_status']    						= "Fehlgeschlagener Status";
$_['description_failed_status']    					= "Status, den der Auftrag einnimmt, wenn sich die Transaktion im Status „Trust Payments fehlgeschlagen“ befindet.";
$_['entry_authorized_status'] 						= "Autorisierter Status";
$_['description_authorized_status'] 				= "Status, den die Bestellung einnimmt, wenn sich die Transaktion im autorisierten Trust Payments-Status befindet. Hier wurde der Betrag vom Kundenkonto reserviert und muss manuell vervollständigt werden.";
$_['entry_voided_status'] 							= "Ungültiger Status";
$_['description_voided_status'] 					= "Status, den die Bestellung einnimmt, wenn sich die Transaktion im Trust Payments-Status „ungültig“ befindet.";
$_['entry_completed_status'] 						= "Abgeschlossen-Status";
$_['description_completed_status'] 					= "Status, den die Bestellung einnimmt, wenn sich die Transaktion im Status „Trust Payments abgeschlossen“ befindet. Dieser Status wird nur gesetzt, wenn eine manuelle Entscheidung für die Erfüllung erforderlich ist.";
$_['entry_fulfill_status'] 							= "Status erfüllen";
$_['description_fulfill_status'] 					= "Status, den die Bestellung einnimmt, wenn sich die Transaktion im Erfüllungsstatus Trust Payments befindet.";
$_['entry_decline_status'] 							= "Status ablehnen";
$_['description_decline_status'] 					= "Status, den die Bestellung einnimmt, wenn sich die Transaktion im Trust Payments-Ablehnungsstatus befindet.";
...
$_['description_administration']					= "Diese Anpassungen fügt Trust Payments-Informationen zur Bestellansicht im Admin-Bereich hinzu und ermöglicht die Initiierung von Vervollständigungen, Rückerstattungen und Stornierungen über Opencart.";
$_['entry_email']									= "Email Bestätigung";
$_['description_email']								= "Sie können Bestellbestätigungs-E-Mails deaktivieren oder aktivieren, indem Sie unsere Änderung „Bestätigungs-E-Mail verhindern“ verwenden. Diese Änderung betrifft nur Bestellungen, die mit dem Zahlungs-Plugin Trust Payments erstellt wurden.";
...
$_['description_events']							= "Diese Anpassungen simuliert Ereignisse, die in späteren Opencart-Versionen vorhanden sind, aber in 2.3.x nicht vorhanden sind. Aufgrund der Art dieser Modifikation müssen alle Modifikationen zweimal aktualisiert werden.";
 ...
 * ===========================================================================================
 */
$_['heading_transaction_list']				        = "TrustPayments Transaktionen";
 ...
 * ===========================================================================================
 */
$_['title_notifications']							= 'Trust Payments Benachrichtigungen';
...
$_['description_trustpayments_id']			= 'Internal ID benutzt von Trust Payments Ressource zu identifizieren';
$_['label_trustpayments_link']				= 'Trust Payments Link';
$_['description_trustpayments_link']		= 'Öffnen Sie die Ressource in der Trust Payments Anwendung';
...
// downloads
$_['description_downloads']							= 'Laden Sie Dokumente herunter, die von Trust Payments erstellt wurden direkt im Shop-Backend. Diese verfügbaren Dokumente hängen von den Einstellungen des Plugins sowie vom Status der Transaktion ab.';
$_['link_download']									= 'Herunterladen';
$_['label_invoice']									= 'Rechnung';
$_['description_invoice']							= 'Hier können Sie das von Trust Payments für diese Transaktion erstellte Rechnungsdokument herunterladen.';
$_['label_packing']									= 'Lieferschein';
$_['description_packing']							= 'Hier können Sie den von Trust Payments erstellten Lieferschein herunterladen für diese Transaktion.';
...
$_['description_external']							= 'External ID übermittelt an Trust Payments. Wird normalerweise im format r-{order id}-{Rückerstattungsnummer} sein';
 ...
 * ===========================================================================================
 */
$_['heading_refund']								= 'Trust Payments Rückerstattung';
...
$_['error_not_trustpayments']				= 'Order id konnte keiner Trust Payments Transaktion zugeordnet werden.';
